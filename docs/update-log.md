...
- Applied the final strong-evidence policy: retained 12 source-reviewed usecases and removed 8 medium/weak candidates from the public README set.
- Updated `data/use-cases.json` with 12 renumbered strong-evidence cases and source-grounded notes.
- Downloaded related media for all 12 retained cases into `media/cases/` and rendered the media in generated README files.
